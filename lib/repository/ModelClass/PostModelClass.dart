...
class PostModelClass {
  ...
  PostModelClass({this.data, this.paginationToken});
  ...
  static List<PostModelClass> fromList(List<Map<String, dynamic>> list) {
    return list.map((map) => PostModelClass.fromJson(map)).toList();
  }
...
class Items {
  ...
  Items.fromJson(Map<String, dynamic> json) {
    ...
    if(json["top_likers"] is List) {
      topLikers = json["top_likers"] == null ? null : List<String>.from(json["top_likers"]);
    }
    if(json["user"] is Map) {
  ...
  Items copyWith({
    ...
    // fbUserTags: fbUserTags ?? this.fbUserTags,
    fbid: fbid ?? this.fbid,
...
// return list.map((map) => FbUserTags.fromJson(map)).toList();
// }
